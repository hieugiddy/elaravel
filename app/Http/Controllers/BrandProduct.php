...
class BrandProduct extends Controller
{
    ...
    public function delete_brand_product($brand_product_id){
        ...
        $count = DB::table('tbl_product')->where('brand_id',$brand_product_id)->count();
        if ($count > 0){
            Session::put('message','Không thể xóa vì vẫn còn tồn tại sản phẩm liên quan đến trường này!');
        return Redirect::to('all-brand-product');
        } else {
