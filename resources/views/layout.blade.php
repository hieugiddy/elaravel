...
<head>
    ...
    <link href="{{asset('public/frontend/css/sidebanner.css')}}" rel="stylesheet">
            ...
            <div class="row">
                <div class="col-sm-3">
                    <div class="left-sidebar">
                        ...
                        <!--/side_banner-->
                        {{-- @foreach($side_banner as $keys => $sidebanner)
                            <div>
                                <img src="public/uploads/slider/{{ $sidebanner->banner_image }}" height="auto" width="100%" class="img img-responsive">
                            </div>
                        @endforeach --}}
                        ...
                        @php 
                            $i = 0;
                        @endphp
                        @foreach($side_banner as $key => $sidebanner)
                            @php 
                                $i++;
                            @endphp
                            <div class="side {{$i==1 ? 'active ' : '' }}">
                               
                                <div>
                                    <img alt="{{$sidebanner->banner_desc}}" src="{{asset('public/uploads/slider/'.$sidebanner->banner_image)}}" height="auto" width="100%" class="img img-responsive">
                                   
                                </div>
                            </div>
                        @endforeach 

                        {{-- src="{{asset('public/uploads/slider/'.$sidebanner->banner_image)}}" --}}
                ...
                <div class="col-sm-9 padding-right">
                   ...
                   @yield('content') <!--mo rong trong home.blade.php-->
