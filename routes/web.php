...
//Side Banner 
Route::get('/manage-side-banner','SideBannerController@manage_sidebanner');
Route::post('/insert-sidebanner','SideBannerController@insert_sidebanner');
Route::get('/add-side-banner','SideBannerController@add_sidebanner');
Route::get('/unactive-sidebanner/{banner_id}','SideBannerController@unactive_sidebanner');
Route::get('/active-sidebanner/{banner_id}','SideBannerController@active_sidebanner');
Route::get('/delete-sidebanner/{banner_id}','SideBannerController@delete_sidebanner');